...
public class LightingFragment extends Fragment implements GjMessageListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "######################## onActivityCreated " + System.currentTimeMillis());
    }

    @Override
    public void onResume() {
        super.onResume();
        // has to happen here, otherwise the button is not selected
        modeAdapter.setSelectedDelayed(modeAdapter.getSelected());
    ...
    public class ModeAdapter extends BaseAdapter {
        ...
        private void init() {
            ...
            for (int i = 0; i < getCount(); i++) {
                ...
                button.setLayoutParams(new GridView.LayoutParams((int) (145 * 2.0), (int) (60 * 2.0)));
                button.setBackgroundResource(R.drawable.light_button);
                button.setTag(i);
                button.setText("Strawberry\nFields " + (i + 1));
        ...
        public void setSelectedDelayed(final int selection) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    modeAdapter.setSelected(selection);
                }
            }, 1000);
        }
    }
